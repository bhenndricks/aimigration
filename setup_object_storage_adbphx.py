"""Setup Object Storage credential and directory in adb_phoenix.
...
Run this against adb_phoenix BEFORE doing Data Pump import.
...
# OCI Object Storage configuration (same as adb_sanjose)
...
def main() -> None:
    print("Setting up Object Storage credential and directory in adb_phoenix...")
    ...
    try:
        ...
        print("An error occurred while setting up Object Storage in adb_phoenix:")
        print(e)
        sys.exit(1)
